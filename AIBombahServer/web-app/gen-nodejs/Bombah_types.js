...
var YouAreDeadException = module.exports.YouAreDeadException = function(args) {
  Thrift.TException.call(this, "YouAreDeadException")
  this.name = "YouAreDeadException"
};
...
var TimeoutException = module.exports.TimeoutException = function(args) {
  Thrift.TException.call(this, "TimeoutException")
...
var PlayerState = module.exports.PlayerState = function(args) {
  this.bombSize = null;
...
PlayerState.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.BYTE) {
        this.bombAmount = input.readByte();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 10:
      if (ftype == Thrift.Type.I32) {
        this.diseaseTicks = input.readI32();
      } else {
        input.skip(ftype);
      }
      break;
...
var MapState = module.exports.MapState = function(args) {
  this.tiles = null;
  this.bombs = null;
  this.players = null;
...
var GameInfo = module.exports.GameInfo = function(args) {
  this.mapWidth = null;
  this.mapHeight = null;
  this.tiles = null;
...
GameInfo.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 6:
      if (ftype == Thrift.Type.I32) {
        this.ticksPerSecond = input.readI32();
      } else {
        input.skip(ftype);
      }
      break;
...
var ControllerState = module.exports.ControllerState = function(args) {
...
ControllerState.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.BOOL) {
        this.directionPadDown = input.readBool();
      } else {
        input.skip(ftype);
      }
      break;
...
var ControllerResult = module.exports.ControllerResult = function(args) {
  this.myState = null;
  this.mapState = null;
  if (args) {
...
ControllerResult.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRUCT) {
        this.myState = new ttypes.PlayerState();
      ...
      case 2:
      if (ftype == Thrift.Type.STRUCT) {
        this.mapState = new ttypes.MapState();
...
var MoveAction = module.exports.MoveAction = function(args) {
  this.direction = null;
  if (args) {
    if (args.direction !== undefined) {
      this.direction = args.direction;
...
var MoveActionResult = module.exports.MoveActionResult = function(args) {
  this.myState = null;
  this.mapState = null;
  if (args) {
    if (args.myState !== undefined) {
...
var BombAction = module.exports.BombAction = function(args) {
...
BombAction.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.BOOL) {
        this.chainBombs = input.readBool();
      } else {
        input.skip(ftype);
      }
      break;
...
var BombActionResult = module.exports.BombActionResult = function(args) {
  this.myState = null;
  this.mapState = null;
  if (args) {
    if (args.myState !== undefined) {
