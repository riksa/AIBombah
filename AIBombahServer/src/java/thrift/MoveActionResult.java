...
public class MoveActionResult implements TBase<MoveActionResult, MoveActionResult._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("MoveActionResult");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(MoveActionResult.class, metaDataMap);
  }
  ...
  private static class MoveActionResultStandardScheme extends StandardScheme<MoveActionResult> {
    ...
    public void read(TProtocol iprot, MoveActionResult struct) throws TException {
      TField schemeField;
    ...
    public void write(TProtocol oprot, MoveActionResult struct) throws TException {
      struct.validate();
  ...
  private static class MoveActionResultTupleScheme extends TupleScheme<MoveActionResult> {
    ...
    @Override
    public void write(TProtocol prot, MoveActionResult struct) throws TException {
    ...
    @Override
    public void read(TProtocol prot, MoveActionResult struct) throws TException {
