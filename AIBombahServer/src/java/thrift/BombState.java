...
public class BombState implements TBase<BombState, BombState._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("BombState");

  private static final TField BLAST_SIZE_FIELD_DESC = new TField("blastSize", TType.BYTE, (short)1);
  private static final TField X_COORDINATE_FIELD_DESC = new TField("xCoordinate", TType.DOUBLE, (short)2);
  private static final TField Y_COORDINATE_FIELD_DESC = new TField("yCoordinate", TType.DOUBLE, (short)3);
  private static final TField TICKS_REMAINING_FIELD_DESC = new TField("ticksRemaining", TType.BYTE, (short)4);
  private static final TField MOVING_FIELD_DESC = new TField("moving", TType.BOOL, (short)5);
  private static final TField DIRECTION_FIELD_DESC = new TField("direction", TType.I32, (short)6);
  private static final TField OWNER_FIELD_DESC = new TField("owner", TType.BYTE, (short)7);
  ...
  static {
    ...
    tmpMap.put(_Fields.BLAST_SIZE, new FieldMetaData("blastSize", TFieldRequirementType.DEFAULT,
        new FieldValueMetaData(TType.BYTE)));
    tmpMap.put(_Fields.X_COORDINATE, new FieldMetaData("xCoordinate", TFieldRequirementType.DEFAULT,
        new FieldValueMetaData(TType.DOUBLE)));
    tmpMap.put(_Fields.Y_COORDINATE, new FieldMetaData("yCoordinate", TFieldRequirementType.DEFAULT,
        new FieldValueMetaData(TType.DOUBLE)));
    tmpMap.put(_Fields.TICKS_REMAINING, new FieldMetaData("ticksRemaining", TFieldRequirementType.DEFAULT,
        new FieldValueMetaData(TType.BYTE)));
    tmpMap.put(_Fields.MOVING, new FieldMetaData("moving", TFieldRequirementType.DEFAULT,
    ...
    FieldMetaData.addStructMetaDataMap(BombState.class, metaDataMap);
  }
  ...
  public BombState setOwner(byte owner) {
    this.owner = owner;
    setOwnerIsSet(true);
    return this;
  }
  ...
  public int compareTo(BombState other) {
    ...
    if (isSetBlastSize()) {
      lastComparison = TBaseHelper.compareTo(this.blastSize, typedOther.blastSize);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetXCoordinate()) {
      lastComparison = TBaseHelper.compareTo(this.xCoordinate, typedOther.xCoordinate);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetYCoordinate()) {
      lastComparison = TBaseHelper.compareTo(this.yCoordinate, typedOther.yCoordinate);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetMoving()) {
      lastComparison = TBaseHelper.compareTo(this.moving, typedOther.moving);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class BombStateStandardScheme extends StandardScheme<BombState> {
    ...
    public void read(TProtocol iprot, BombState struct) throws TException {
      TField schemeField;
    ...
    public void write(TProtocol oprot, BombState struct) throws TException {
      struct.validate();
  ...
  private static class BombStateTupleScheme extends TupleScheme<BombState> {
    ...
    @Override
    public void write(TProtocol prot, BombState struct) throws TException {
    ...
    @Override
    public void read(TProtocol prot, BombState struct) throws TException {
