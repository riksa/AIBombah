...
public class ControllerResult implements TBase<ControllerResult, ControllerResult._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("ControllerResult");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(ControllerResult.class, metaDataMap);
  }
  ...
  private static class ControllerResultStandardScheme extends StandardScheme<ControllerResult> {
    ...
    public void read(TProtocol iprot, ControllerResult struct) throws TException {
      TField schemeField;
    ...
    public void write(TProtocol oprot, ControllerResult struct) throws TException {
      struct.validate();
  ...
  private static class ControllerResultTupleScheme extends TupleScheme<ControllerResult> {
    ...
    @Override
    public void write(TProtocol prot, ControllerResult struct) throws TException {
    ...
    @Override
    public void read(TProtocol prot, ControllerResult struct) throws TException {
